...
Feature: Verify Xealei Individuals > Edit Individual Page
 ...
 Background: 
  ...
  And  User should update existing phone number in emergency contact1 and verify the error message for duplicate Mobile Number "Individual already exist with same phone number"
  And  User should delete all the fields and perform update and verify the Required field toast message "Please provide valid data / Enter all required fields"
  ...
  And  User should perform update without enter any fields in emergency and verify the Required field toast message "Please provide valid data / Enter all required fields"
  ...
  And  User should click Add another emergency contact
  And  User should perform firstName* and lastName* fields in Add another emergency contact3 for limits and verify the limit validation error message in Emergency Contact3 First, Last Name* fields "First name cannot be longer than 30 characters" and "Last name cannot be longer than 30 characters"
 ...
 #Then User should verify the calendar should close after click outside the calendar
  ...
  Then User should verify the breadcrums link should be display with module individual name > Edit individual
  And  User should perform update with empty fields in vitals tab and verify the Required field toast message "Please provide valid data / Enter all required fields"
