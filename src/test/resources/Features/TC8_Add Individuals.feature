...
Feature: Verify Xealei Individuals > Add Individual Page
  ...
  Scenario: To verify the validation messages for limit and mandatory fields in Add Individuals page
    ...
    Then User should Add Individual by perform only non mandatory fields and verify the Required field toast message "Please provide valid data / Enter all required fields"
    ...
    And User should click on the calendar icon and verify the date picker should appeared
    ...
    And User should uncheck the Same as Residential address checkbox and enter address in Mailing Address * field    
    And User should tick the same as Residential address after entering different address in Mailing address
    Then User should verify the Residential Address * and Mailing Address * fields values are same
    And User should uncheck the Same as Residential address checkbox and verify the validation error message for Mailing Address * field "Please enter mailing address"
    And User should delete the exist data in Residential Address * field and verify the validation error message for Residential Address * field "Please enter residential address"
    ...
    Then User should verify the limit validation error message in Emergency Contact3 First Name* field "First name cannot be longer than 30 characters", "Last name cannot be longer than 30 characters"
    ...
    And User should perform emergency contact1 with different phone number and verify the error message for duplicate Mobile Number "Individual already exist with same phone number"
  ...
  Scenario: To verify the user able to Add/Create Individual by entering only mandatory fields
    ...
    Then User should verify the availability status also check whether Availability field is disabled for mapped suite with individual that is for status "Occupied"
...
@SanityTesting
  Scenario: To verify the user able to Add/Create Individual by entering all fields
    ...
    And User should perform update without enter any fields in vitals tab and verify the Required field toast message "Please provide valid data / Enter all required fields"
