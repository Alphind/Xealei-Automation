...
//            waitForPageLoad();
	...
	public void user_should_verify_the_validation_info_message_under_all_fields(String expIndDetailsInfoMsg,
		...
		staffpom.getIncidentReportPage().eventDateAndTime(1);
	...
	public void user_should_validation_info_message_is_thrown_under_event_time_for_selecting_greater_than_current_time_of_current_date(
		...
		try {
			...
			log(Status.PASS,
					"Validation info message is displayed after enter greater than current time of current date as expected Exp info Msg - "+expGreaterThanCurrentTime
						+" Actual info msg -"+ getText(staffpom.getIncidentReportPage()
									.getExceedCurrentTimeIneventDateAndTimeValidationInfoMsg()));
	...
	public void user_is_login_into_xealei_application_as_staff_role_user_with_valid_and(String StaffUserName,
