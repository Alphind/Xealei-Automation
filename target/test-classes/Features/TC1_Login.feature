...
@1
  Scenario: Comprehensive Login Page UI Testing
    ...
    Then User should verify "PRIVACY POLICY" popup should be displayed after click the Privacy Policy link
  ...
  Scenario: To verify the error validation messages in Login page
    And User should enter password in password field and click login button
    ...
    And User should click login button without enter username and password
    Then User should verify the error message contains for both email and password after click the Login button "Please enter email ID" and "Please enter password"
